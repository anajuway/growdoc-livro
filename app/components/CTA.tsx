...
export default function CTA() {
  return (
    <footer className="relative overflow-hidden">
      {/* CTA block */}
      <div className="relative min-h-[75vh] flex flex-col items-center justify-center px-6 text-center">
        {/* Background */}
        ...
        >
          ...
          >
            ...
            Guia de Sobrevivência no Marketing Para Médicos
          </motion.div>
          ...
          <p className="mt-6 text-white/20 text-sm">
            Livro Digital GrowDoc · Marketing Médico com critério
          </p>
        </motion.div>
      </div>
